...
- 单机选将转入招募时，最终安卓日志仍有一次can_process/is_inside_tree引擎告警；之后已正常进入酒馆。它不属于脚本或着色器编译错误，但仍作为未解决告警记录，未声称日志全无错误。
...
[v0.59.0发行页](https://github.com/bjckbjckbjck-ai/classic-tavern-builds/releases/tag/v0.59.0)的5个附件已从公开链接实际下载并核对SHA-256/字节数，与本地交付一致；latest指向v0.59.0。#18已回复本轮完成项并保留未解决问题，状态仍开放。
