...
[v0.60.0发行页](https://github.com/bjckbjckbjck-ai/classic-tavern-builds/releases/tag/v0.60.0)4个附件已从公开链接实际下载并核对SHA-256和字节数，与本地交付一致，latest指向本版。#18已回复本轮AI说明界面及验证边界，保持开放。安卓后续实际拖拽上阵并进入战斗，见12-played/13-bot-round截图；这些是触控与流程证据，不等同中后期性能测试。
